...
class LinkedCompanySpider(scrapy.Spider):
    ...
    API_KEY = "d0de9851-28c1-4a89-b493-50b7242bf73e"
    ...
    company_pages = [
        ...
        # 'https://www.linkedin.com/company/Google?trk=public_jobs_jserp-result_job-search-card-subtitle'
        ]
    ...
    def start_requests(self):
        ...
        yield scrapy.Request(url=self.get_proxy_url(first_url), callback=self.parse_response, meta={'company_index_tracker': company_index_tracker})
    ...
    def parse_response(self, response):
        ...
        if company_index_tracker <= (len(self.company_pages)-1):
            ...
            yield scrapy.Request(url=self.get_proxy_url(next_url), callback=self.parse_response, meta={'company_index_tracker': company_index_tracker})
